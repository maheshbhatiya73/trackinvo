...
export default function CreativeQuotation({ quotationData, themeColor = "#6366f1" }: any) {
  const {
    customer_id,
    issue_date,
    expiry_date,
  ...
  const statusColor = isExpired ? "#DC2626" : "#047857";
    ...
    >
      ...
      >
        <div style={{ marginBottom: "16px" }}>
          ...
          <div style={{ marginTop: "8px", fontSize: "14px", color: "#4B5563" }}>
            <p>System ID: {quotationData._id}</p>
      ...
      >
        <div style={{ flex: "1", minWidth: "200px" }}>
          ...
          >
            <span style={{ marginRight: "8px", color: themeColor }}>👤</span> Quote To
          </h3>
      ...
      >
        ...
        {products.map(
          (product: {
            ...
            >
              <div>
                <p style={{ fontWeight: "500", color: "#1F2937" }}>{product.product_id.name}</p>
              </div>
      ...
      >
        ...
        <p style={{ marginTop: "4px" }}>
          Generated by TrackQuote | Contact: support@trackquote.com
        </p>
      </div>
    </div>
  );
