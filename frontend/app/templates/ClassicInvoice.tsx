export default function ClassicInvoice({ invoiceData, themeColor = "#87CEEB" }:any) { // Skyblue hex
  const { customer_id, issue_date, due_date, reference_number, products, total_amount, note } = invoiceData;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "14px", color: "#666666" }}>
          We appreciate your trust in TrackInvo. Please reach out if you have any questions.
        </p>
