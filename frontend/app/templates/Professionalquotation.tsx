...
export default function ProfessionalQuotation({ quotationData, themeColor = "#6366f1" }: any) {
  const { customer_id, issue_date, expiry_date, products, total_amount, reference_number, discount_amount, discount_type, note } = quotationData;
    ...
    >
          ...
          <div style={{ fontSize: "14px" }}>
            ...
            >
              ...
              <span style={{ fontWeight: "500", color: "#1F2937" }}>
                ${(total_amount + (discount_amount || 0)).toFixed(2)}
              </span>
            </div>
            {discount_amount && (
              <div
      ...
      {note && (
        <div style={{ marginBottom: "32px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#4B5563" }}>{note}</p>
        </div>
      )}
        ...
        >
          ...
          <div style={{ display: "flex", gap: "16px" }}>
            ...
            <p>
              Email:{" "}
              <a
                href="mailto:support@trackquote.com"
                style={{ color: themeColor, textDecoration: "none" }}
              >
                support@trackquote.com
              </a>
            </p>
          </div>
        </div>
