...
export default function CompactInvoice({ invoiceData, themeColor = "#6366f1" }: any) {
  const { customer_id, products, total_amount, issue_date, due_date, reference_number } = invoiceData;
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span style={{ color: "#4b5563" }}>{formatDate(due_date)}</span>
            </div>
          </div>
        </div>
      </header>
      ...
      >
        <p>Thank you for your TrackInvo!</p>
        <p style={{ marginTop: "5px" }}>Please make payment by the due date</p>
      </footer>
    </div>
  );
}