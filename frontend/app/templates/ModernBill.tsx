...
export default function ModernBill({ invoiceData, themeColor = "#6366f1" }: any) {
  const { customer_id, issue_date, due_date, products, total_amount, reference_number, discount_type, discount_amount, note } = invoiceData;
  ...
  >
    ...
    >
      ...
      >
        ...
        <p style={{ fontWeight: "500" }}>{new Date(due_date).toLocaleDateString()}</p>
      </div>
      <div
        style={{
          flex: "1",
      ...
      <div style={{ flex: "1", minWidth: "250px" }}>
        ...
        <div style={{ fontSize: "14px" }}>
          ...
          >
            ...
            <span style={{ fontWeight: "500" }}>**** 4532</span>
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <span style={{ fontWeight: "500" }}>021000021</span>
          </div>
          <div
            style={{
              marginTop: "16px",
          ...
          >
            <p style={{ fontSize: "12px", color: "#6B7280" }}>
              Make payable to: Company Name LLC
            </p>
          </div>
        </div>
      </div>
        ...
        <div style={{ paddingTop: "16px", borderTop: "1px solid #E5E7EB" }}>
          ...
          >
            ...
            <span style={{ color: themeColor }}>
              ${(total_amount - discount_amount).toFixed(2)}
            </span>
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        >
          Scan QR code with mobile payment app
        </p>
      </div>
    </div>
    ...
    <div style={{ marginTop: "48px", paddingTop: "32px", borderTop: "1px solid #E5E7EB" }}>
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: "12px", color: "#6B7280" }}>
            Invoice generated by TrackInvo Pro
          </p>
        </div>
