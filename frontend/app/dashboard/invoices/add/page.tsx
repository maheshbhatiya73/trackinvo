...
const invoiceTemplates = [
  { id: "template-001", name: "Classic Invoice" },
  { id: "template-002", name: "Modern Bill" },
  { id: "template-003", name: "Professional Statement" },
  { id: "template-004", name: "Creative Receipt" },
  { id: "template-005", name: "Compact Invoice" },
];
...
const CreateInvoicePage = () => {
  ...
  const [cycle, setCycle] = useState<string>('month');
  ...
  // Fetch selected template from localStorage on mount
  useEffect(() => {
    const savedTemplateId = localStorage.getItem('selectedTemplateId');
    if (savedTemplateId) {
      setSelectedTemplateId(savedTemplateId);
      const template = invoiceTemplates.find(t => t.id === savedTemplateId);
  ...
  const validateForm = () => {
    ...
    if (!selectedTemplateId) newErrors.template = 'Please select an invoice template';
  ...
  const handleSubmit = async () => {
    ...
    const invoiceData = {
      ...
      note: notes,
      invoice_template_id: selectedTemplateId, // Use template ID from localStorage
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Dropdown
                  ...
                  name="customer"
                  onChange={(value) => setSelectedCustomer(value)} // Changed to accept string value directly
              ...
              <div className="flex items-center space-x-2">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm w-40 text-gray-700">Recurring Invoice</span>
                </label>
                {isRecurring && (
                  <Dropdown
                  options={[
                  ...
                  value={cycle}
                  name="cycle"
                  onChange={(value) => setCycle(value)} // Changed to accept string value directly
                  className="w-full"
              />
                )}
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {selectedProducts.map(product => (
                <div key={product.product_id} className="group grid grid-cols-12 gap-4 items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
